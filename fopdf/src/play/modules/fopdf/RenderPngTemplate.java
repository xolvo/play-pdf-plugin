...
public class RenderPngTemplate extends Result {
	...
	public RenderPngTemplate(Template template, Map<String, Object> args) {
		name = template.name;
		content = template.render(args);
		
		filename = (name != null ? name : Codec.UUID()) + ".png";
	}
	...
	public void apply(Request request, Response response) {
		try {
			...
			setContentTypeIfNotSet(response, "image/png");
			
			Fop fop = PdfPlugin.factory().newFop(MimeConstants.MIME_PNG, response.out);
